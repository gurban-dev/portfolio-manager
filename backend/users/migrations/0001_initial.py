    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_currency', models.CharField(choices=[('EUR', 'Euro'), ('NOK', 'Norwegian Krone'), ('SEK', 'Swedish Krona'), ('GBP', 'British Pound'), ('USD', 'United States Dollar'), ('CHF', 'Swiss Franc')], default='EUR', max_length=3)),
