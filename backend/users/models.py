...
# CustomUser identifies who the person is and stores their personal settings.
class CustomUser(AbstractUser):
  email_address = models.EmailField(unique=True)

  email_verified = models.BooleanField(default=False)

  # A unique UUID is automatically created for every user.
  # This uid is passed to as a URL parameter to establish a unique web
  # socket communication for each user.
...
# Account stores the user’s financial data.
