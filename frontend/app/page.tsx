...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 text-gray-800 flex flex-col">
      {/* Navbar */}
      <nav className="flex justify-between items-center px-8 py-4 shadow-sm bg-white/70 backdrop-blur-md">
        ...
        <div className="flex gap-4">
          <Link href="/auth/login" className="text-sm font-medium text-gray-700 hover:text-slate-900">
            Login
          </Link>
          <Link
            href="/auth/register"
      ...
      {/* Hero Section */}
      <section className="flex flex-col md:flex-row items-center justify-between px-8 md:px-16 py-20 md:py-32 gap-12">
        <motion.div
      ...
      <section className="bg-white py-20 px-8 md:px-16">
        <h3 className="text-3xl font-bold text-center mb-14 text-slate-900">Why Choose FinSight?</h3>
      ...
      <footer className="mt-auto bg-slate-900 text-gray-200 py-10 px-8 md:px-16">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-sm">© {new Date().getFullYear()} FinSight. All rights reserved.</p>
