...
function useAuth() {
    ...
    const fetchUser = async ()=>{
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get('/users/me/');
            setUser(res.data);
        } catch  {
            setUser(null);
        } finally{
    ...
    const login = async (credentials)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post('/auth/login/', credentials);
        fetchUser();
    };
    const logout = async ()=>{
...
function NotificationBell() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const fetchNotifications = async ()=>{
           ...
           are unread. */ const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get('/notifications/?unread=true');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__611f48a3._.js.map