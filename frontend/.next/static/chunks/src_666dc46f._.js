...
function ESGScoreList() {
    _s();
    const { data: scores, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useFetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFetch"])('/api/v1/investments/esg-scores/');
