...
function AccountForm() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post('/accounts/', form);
        setForm({
            name: '',
            institution: '',
            balance: '',
...
function AccountList() {
    _s();
    const { data: accounts, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useFetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFetch"])('/accounts/');
