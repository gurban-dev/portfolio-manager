...
function useAuth() {
    ...
    const fetchUser = async ()=>{
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["api"].get('/api/v1/users/me/');
            setUser(res.data);
        } catch (e) {
            setUser(null);
        } finally{
    ...
    const login = async (credentials)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["api"].post('/api/auth/login/', credentials);
        fetchUser();
    };
    const logout = async ()=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["api"].post('/api/auth/logout/');
        setUser(null);
    };
    return {
        user,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react/index.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useAuth.ts [client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
_s(Login, "zlk6HG7dVig0+Hza3J964pqbKyo=", false, function() {
    return [
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/src/pages/auth/login.tsx [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/src/pages/auth/login.tsx\" }", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dcfcb646._.js.map