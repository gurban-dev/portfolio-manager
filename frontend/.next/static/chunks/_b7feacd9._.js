...
function GoogleLoginButton() {
    ...
    const googleLogin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$oauth$2f$google$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGoogleLogin"])({
        onSuccess: {
            "GoogleLoginButton.useGoogleLogin[googleLogin]": async (tokenResponse)=>{
                console.log('✅ Google OAuth success — tokenResponse:', tokenResponse);
                setIsLoading(true);
                setError(null);
                try {
                    const { user, created } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].loginWithGoogle(tokenResponse.access_token);
...
function LoginPage() {
    ...
    const handleEmailLogin = async (e)=>{
        ...
        setError(null);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].login(email, password);
            router.push('/dashboard');
        } catch (err) {
...
//# sourceMappingURL=_b7feacd9._.js.map